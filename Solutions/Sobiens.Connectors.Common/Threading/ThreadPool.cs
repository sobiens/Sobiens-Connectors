...
namespace Sobiens.Connectors.Common.Threading
{
    ...
    public sealed class ThreadPool : WaitHandle
    {
        ...
        /// It is not thread safe and can only be set before Start is called.
        /// </summary>
        ...
        /// <summary>
        /// If a dynamic thread is idle for this period of time w/o processing work requests, it will exit.
        /// It is not thread safe and can only be set before Start is called.
        /// </summary>
        ...
        /// <summary>
        /// Throttle for maximum # of work requests that can be added.
        /// </summary>
        ...
        /// <summary>
        /// MaxThreads - [Current # of threads in the pool (static + dynamic)]
        /// </summary>
        ...
        /// <summary>
        /// Cap for thread count.  Threads added above initialThreadCount are called "dynamic" threads.
        /// </summary>
        ...
        /// <summary>
        /// Read-only flag for the ThreadPool to determine if it has been started 
        /// </summary>
        ...
        /// <summary>
        /// Flag to propogate Thread.CurrentPrincipal
        /// </summary>
        ...
        /// <summary>
        /// Flag to propogate Thread.CurrentContext
        /// </summary>
        ...
        /// </summary>
        /// <param name="request">Request that is posted to the ThreadPool</param>
        /// <returns>True if successfulled added to the pool, false otherwise</returns>
