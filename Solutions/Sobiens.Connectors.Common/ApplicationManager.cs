...
namespace Sobiens.Connectors.Common
{
    public abstract class ApplicationManager
    {
        ...
        public abstract List<CompareObjectsResult> GetObjectDifferences(ISiteSetting sourceSiteSetting, Folder sourceFolder, ISiteSetting destinationSiteSetting, Folder destinationFolder, Action<int, string> reportProgressAction);
